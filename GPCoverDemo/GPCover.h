...
#import "GPCoverEnum.h"


typedef void(^showBlock)(void);
typedef void(^hideBlock)(void);

@interface GPCover : UIView<CAAnimationDelegate>
...
+ (void)coverFrom:(UIView *)fromView
      contentView:(UIView *)contentView
            style:(GPCoverStyle)style
        showStyle:(GPCoverShowStyle)showStyle
        animStyle:(GPCoverAnimStyle)animStyle
         notClick:(BOOL)notClick;
...
+ (void)coverFrom:(UIView *)fromView
      contentView:(UIView *)contentView
            style:(GPCoverStyle)style
        showStyle:(GPCoverShowStyle)showStyle
    showAnimStyle:(GPCoverShowAnimStyle)showAnimStyle
    hideAnimStyle:(GPCoverHideAnimStyle)hideAnimStyle
         notClick:(BOOL)notClick;
